...
COMBINED_RESET_AND_MEASUREMENT_INSTRUCTION_NAMES: frozenset[str] = frozenset(["MR", "MRX", "MRY", "MRZ"])
...
MULTIPLE_QUBIT_MEASUREMENT_INSTRUCTION_NAMES: frozenset[str] = frozenset(["MXX", "MYY", "MZZ", "MPP"])
