...
class CorrelationSurfaceTransformationHelper:
    def __init__(self, block_graph: BlockGraph, pipe_length: float):
        """Helper class to compute transformations of each piece of a correlation surfaces in a
        COLLADA model.
    ...
    def get_transformations_for_correlation_surface(
        ...
        """Compute the list of transformations (with corresponding bases) that represent each piece
        of the given correlation surface in the COLLADA model.
        """
